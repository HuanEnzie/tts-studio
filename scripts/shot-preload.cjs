...
const settings = { outputRoot: 'C:/Users/Acer/Documents/TTS Studio', model: 'gemini-3.1-flash-tts-preview', defaultVoice: 'Kore', defaultStyle: '', voiceInstruction: 'Giọng nam miền Bắc, trầm ấm, truyền cảm.', scene: 'Quảng cáo sôi động, kêu gọi mua ngay.', temperature: 1, seed: 42, filenameTemplate: '{date}_{project}_{index}_{slug}', format: 'mp3', concurrency: 4, dailyBudgetUsd: 5, cacheEnabled: true, priceInputPerM: 0.5, priceAudioPerM: 10, requestTimeoutSec: 120, proxyUrl: '' }
const dict = [
  { id: 'd1', pattern: 'TP.HCM', replacement: 'Thành phố Hồ Chí Minh', enabled: true },
  { id: 'd2', pattern: 'iPhone', replacement: 'ai phôn', enabled: true }
]
const presets = [
  { id: 'pre1', name: 'TVC nam Bắc', voice: 'Charon', context: 'Giọng nam miền Bắc, truyền cảm', scene: 'Quảng cáo sôi động', style: '', temperature: 0.6, seed: 7 },
  { id: 'pre2', name: 'Đọc sách nữ', voice: 'Kore', context: 'Giọng nữ ấm, chậm rãi', scene: 'Kể chuyện', style: '', temperature: 1, seed: 1234 }
]
